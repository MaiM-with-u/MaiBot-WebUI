...
const staticRoutes: AppRouteRecordRaw[] = [
  ...
  },
  {
    ...
    component: Home,
    name: 'ConfigEditor',
    meta: { title: 'menus.configEditor.title' },
    children: [
      {
        path: RoutesAlias.EnvConfig,
        name: 'EnvConfig',
        component: () => import('@views/config-editor/env/index.vue'),
        meta: { title: 'menus.configEditor.env', keepAlive: true }
      },
      {
        path: RoutesAlias.MainConfig,
        name: 'MainConfig',
        component: () => import('@views/config-editor/main/index.vue'),
        meta: { title: 'menus.configEditor.main', keepAlive: true }
      }
    ]
  }
]
