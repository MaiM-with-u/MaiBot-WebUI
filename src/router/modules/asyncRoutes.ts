...
export const asyncRoutes: MenuListType[] = [
  ...
  },
  {
    ...
    component: RoutesAlias.Home,
    meta: {
      title: 'menus.configEditor.title',
      icon: '&#xe721;',
      keepAlive: false
    },
    children: [
      {
        ...
        path: 'env',
        name: 'Env',
        component: RoutesAlias.EnvConfig,
        meta: {
          title: 'menus.configEditor.env',
          keepAlive: true
        }
      },
      {
        ...
        path: 'main',
        name: 'Main',
        component: RoutesAlias.MainConfig,
        meta: {
          title: 'menus.configEditor.main',
          keepAlive: true
        }
      }
    ]
      ...
      children: [
        {
          ...
          path: 'chat',
          name: 'Chat',
          component: RoutesAlias.LocalChat,
          meta: {
            title: '本地聊天',
            keepAlive: true
          }
