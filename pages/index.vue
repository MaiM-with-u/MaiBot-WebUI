  ...
  <div class="p-6">
    ...
    <div class="mb-6">
      <UCard>
        ...
        <!-- 状态内容将通过API获取 -->
        <UStatusIndicator color="green" class="mb-2">
          运行中
        </UStatusIndicator>
      </UCard>
    </div>
      ...
      <UCard>
        ...
        <div class="grid grid-cols-3 gap-4">
          <div>
            ...
            <UProgress value="45" class="mt-2" />
          </div>
          <div>
            <p class="text-sm text-gray-500">
              内存使用率
            </p>
            <UProgress value="60" class="mt-2" />
          </div>
          <div>
            <p class="text-sm text-gray-500">
              磁盘使用率
            </p>
            <UProgress value="30" class="mt-2" />
          </div>
        </div>
      </UCard>
    </div>
